            ...
            <div class="col-md-12 no-padding">
              <div class="aa-promo-right">
                ...
                <div class="aa-single-promo-right">
                  <div class="aa-promo-banner" style="height:200px">
      ...
      <div class="col-md-12">
        <div class="row">
          <div class="aa-banner-area">
            <a href="#"><img src="{{asset('storage/media/banner/1613593671.jpg')}}" alt="fashion banner img"></a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="col-md-12">
        <div class="aa-client-brand-area">
          <ul class="aa-client-brand-slider">
            ...
            <li><a href="#"><img src="{{asset('storage/media/brand/'.$list->image)}}" alt="{{$list->name}}" style="height:100px;width:250px;"></a></li>
            @endforeach
          </ul>
        </div>
      </div>
