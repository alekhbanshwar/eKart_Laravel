                  ...
                  <div id="demo-1" class="simpleLens-gallery-container">
                    <div class="simpleLens-container">
                      <div class="simpleLens-big-image-container">
                        <a data-lens-image="{{asset('storage/media/'.$product[0]->image)}}" class="simpleLens-lens-image"><img src="{{asset('storage/media/'.$product[0]->image)}}" class="simpleLens-big-image"></a>
                        </div>
                    </div>
              ...
              <div class="col-md-7 col-sm-7 col-xs-12">
                <div class="aa-product-view-content">
                  ...
                  <div class="aa-color-tag">
                    ...
                    <a href="javascript:void(0)" class="aa-color-{{strtolower($attr->color)}} product_color size_{{$attr->size}}" id="tooltip" onclick=change_product_color_image("{{asset('storage/media/'.$attr->attr_image)}}","{{$attr->color}}")>
                      <span class="tooltiptext">{{strtolower($attr->color)}}</span>
                    </a>
            ...
            <ul class="aa-product-catg aa-related-item-slider">
              ...
              <li>
                <figure>
                  ...
                  <figcaption>
                    <h4 class="aa-product-title" style="width: 252px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;"><a href="{{url('product/'.$productArr->slug)}}">{{$productArr->name}}</a></h4>
