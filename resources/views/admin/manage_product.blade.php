            ...
            <div class="col-lg-12">
               <div class="card">
                  <div class="card-body">
                     ...
                     <div class="form-group">
                        <label for="image" class="control-label mb-1"> Image (250px * 300px)</label>
                        ...
                        @enderror
                        @if($image!='')
                        <a href="{{asset('storage/media/'.$image)}}" target="_blank"><img height="50px" width="100px" src="{{asset('storage/media/'.$image)}}" /></a>
                        @endif
                     </div>
                     <div class="form-group">
                        <div class="row">
