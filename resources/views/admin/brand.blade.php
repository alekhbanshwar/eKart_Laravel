...
<div class="sufee-alert alert with-close alert-success alert-dismissible fade show" id="hideAlert">
    {{session('message')}}
...
<div class="row m-t-30">
    <div class="col-md-12">
        ...
        <div class="table-responsive table-responsive-data2 ">
            <table class="table table-borderless table-data3 display" width="100%" id="paginationSearch">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Brand</th>
