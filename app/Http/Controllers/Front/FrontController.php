...
class FrontController extends Controller
{
    ...
    public function order(Request $request)
    {
        $result['orders'] = DB::table('orders')
            ->select('orders.*', 'orders_statuses.orders_status')
            ->leftJoin('orders_statuses', 'orders_statuses.id', '=', 'orders.order_status')
    ...
    public function order_detail(Request $request, $id)
    {
        $result['orders_details'] =
            ...
            ->select('orders.*', 'order_details.price', 'order_details.qty', 'products.name as pname', 'products_attr.attr_image', 'sizes.size', 'colors.color', 'orders_statuses.orders_status')
